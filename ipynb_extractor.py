...
if __name__ == "__main__":
    ...
    print("\nipynb_extractor version: {}".format(VERSION))


# Put the Constants with lots of text at the end. Makes the code easier to read.

HELP_FULL = """Usage: ipynb_extractor [OPTION]... [FILE]...
...
creating an ipynb file. As an example the ipynb_extractor utility may be 
...
HELP_BRIEF = """Usage: ipynb_extractor [OPTION]... [FILE]...
